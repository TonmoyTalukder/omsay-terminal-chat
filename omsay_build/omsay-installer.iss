...
[Icons]
Name: "{group}\OMSAY"; Filename: "{app}\omsay.exe"; IconFilename: "{app}\omsay.ico"
Name: "{group}\OMSAY Server"; Filename: "{app}\omsay-server.exe"; IconFilename: "{app}\omsay.ico"
Name: "{commondesktop}\OMSAY"; Filename: "{app}\omsay.exe"; WorkingDir: "{app}"; IconFilename: "{app}\omsay.ico"
